...
export const SEO = {
  ...
  // デフォルトの説明
  description:
    "クアドラティックボーティングとは台湾デジタル大臣オードリー・タン氏が紹介したことから、世界中に広がっている投票方法です。QuadraticVoting.jpは少数派の選択肢の意見にも耳を傾け、多くの意見を尊重するクアドラティックボーティングを採用したアンケートフォームです。",
  //【共通】
  additionalMetaTags: [
    {
  ...
  // 【共通】キーワード
  keywords:
    "クアドラティックボーティング,投票,1人1票,民主主義,オードリータン,Quadratic Voting",
